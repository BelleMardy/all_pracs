...
almost_numbers = [int(i) for i in almost_numbers]  # DONE - TO DO: use a list comprehension to create a list of integers
print(almost_numbers)  # numbers =

for i in almost_numbers:
    almost_numbers = [int(i)]
    print(almost_numbers, end="")
print()

full_names = [element.lower() for element in full_names]
print(full_names)
